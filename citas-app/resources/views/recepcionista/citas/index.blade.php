...
<head>
    ...
    <title>Citas — Recepcionista | FCD</title>
    <style>
        :root {
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pg-disabled { color: #ccc; background: #fafafa; cursor: default; }
    </style>
</head>
<body>
<header class="navbar">
    <div class="navbar-brand">
        <span class="dot">❤</span> FCD — Recepcionista
    </div>
    <nav>
...
<div class="container">
    <div class="page-title">
        <div>
            ...
            <div class="subtitle">Recepcionista · Todas las citas</div>
        </div>
        <a href="{{ route('recepcionista.citas.create') }}" class="btn btn-green">➕ Nueva Cita</a>
    </div>
    ...
    @if($appointments->isEmpty())
        <div class="empty">
            ...
            <a href="{{ route('recepcionista.citas.index') }}" class="btn btn-ghost" style="margin-top:.9rem">Ver todas</a>
        </div>
    @else
